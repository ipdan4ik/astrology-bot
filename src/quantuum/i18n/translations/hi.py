...
TRANSLATIONS = {
    ...
    "status.generating": "तैयार हो रही है",
    "status.done": "तैयार",
    ...
    # -------------------------------------------------------------------------
    "help.text": (
        "मैं आपके जन्म डेटा से व्यक्तिगत ज्योतिषीय विश्लेषण (Quantuum Blueprint) तैयार करता हूँ।\n\n"
        "नीचे का मेनू:\n"
        "🔮 विश्लेषण — विश्लेषण जनरेट करें\n"
        "👤 प्रोफ़ाइल — जन्म डेटा देखें और संपादित करें\n"
        "📜 इतिहास — पिछले विश्लेषण\n\n"
        "कमांड: /start /profile /blueprint\n"
    ...
    "daily.status_on": "दैनिक राशिफल चालू है। डिलीवरी समय: {hour}:00 (आपका टाइमज़ोन)।",
    ...
    "daily.hour_set": "डिलीवरी समय: {hour}:00 ✅",
    ...
    "onb.done": "हो गया! आपकी प्रोफ़ाइल सहेजी गई। /blueprint कमांड से आपका विश्लेषण जनरेट होगा।",
}
