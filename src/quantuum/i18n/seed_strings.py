...
BASE_STRINGS: dict[str, dict[str, str]] = {
    ...
    "help.text": {
        "ru": (
            ...
            "Меню:\n"
            "❓ Спросить астролога — вопрос астрологу с твоим натальным контекстом\n"
            "📖 Разборы — Blueprint, Транзиты, BaZi, Human Design, Таро и др.\n"
            "🔔 Ежедневный гороскоп — ежедневная доставка гороскопа\n"
            "👤 Профиль — дата, время и место рождения\n"
            "📜 История — все прошлые разборы\n"
            "💳 Купить — пакеты и подписки\n"
        ...
        "en": (
            ...
            "Menu:\n"
            "❓ Ask the astrologer — question with your natal context\n"
            "📖 Readings — Blueprint, Transits, BaZi, Human Design, Tarot and more\n"
            "🔔 Daily horoscope — daily horoscope delivery\n"
            "👤 Profile — birth date, time and place\n"
            "📜 History — all past readings\n"
            "💳 Buy — packages and subscriptions\n"
