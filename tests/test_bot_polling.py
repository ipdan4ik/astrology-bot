...
async def test_run_calls_delete_webhook_and_start_polling():
    ...
    with (
        ...
        patch("quantuum.bot.polling.ensure_base_strings"),
        patch("quantuum.bot.polling.get_default_tenant_id", new=AsyncMock(return_value=1)),
        patch("quantuum.bot.polling.ensure_tenant_default_language"),
